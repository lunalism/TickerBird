...
export default function LoginPageClient() {
  ...
  return (
    ...
    // 모바일: 상단 헤더(3.5rem) + 하단 탭바(4rem) 제외, pb-16으로 시각적 중앙보다 위에 배치
    // 데스크탑: 전체 화면 높이에서 중앙 정렬
    <div className="flex min-h-[calc(100vh-7.5rem)] items-center justify-center bg-background px-4 pb-16 md:min-h-screen md:pb-0">
      {/* 로그인 카드 */}
